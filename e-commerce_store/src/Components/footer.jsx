        ...
        <div >        
            <div className='footerBox'>          
                ...
                <div className='footerLinks'>            
                    <h2 style={{marginTop: '40px', marginLeft: '30px', fontFamily: 'bahnschrift'}} >
                    Links
                    </h2>
                    ...
                    <li>
                        <a href="index.html"
                            style={{ color: 'white', textDecoration: 'none', fontFamily: 'bahnschrift' }} >
                            Home
                        </a>
                    </li>
                    <li>
                ...
                <div className='footerLinks'>
                    <h2 style={{marginTop: '40px', marginLeft: '30px'}}>Social Media</h2>
                    <ul >
                        <li>
                            <a href="index.html"
                                style={{ color: 'white', textDecoration: 'none', fontFamily: 'bahnschrift' }} >
